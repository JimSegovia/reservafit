...
import { ArrowLeft, Plus, Search, Edit2, Trash2, X, Calendar } from "lucide-react";
      ...
      <div className="flex-grow flex flex-col overflow-y-auto custom-scroll px-6 py-6 pb-20">
        ...
        <header className="flex justify-between items-center mb-6 select-none">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-black text-neutral-950">Clases</h2>
          </div>
          ...
          {filteredClasses.length === 0 ? (
            ...
            filteredClasses.map((cls) => {
              ...
              return (
                <div
                  key={cls.id}
                  className="bg-white border border-neutral-250 rounded-2xl p-4 flex justify-between items-center shadow-sm"
                >
                  <div className="flex items-center flex-1 min-w-0 mr-2">
                    {/* Circle Image Placeholder */}
                    <div className="w-12 h-12 rounded-xl bg-neutral-100 shrink-0 mr-3 flex items-center justify-center text-neutral-400">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[11px] text-neutral-500 font-bold mt-0.5 truncate">
                        Instructor: {cls.instructorName} • S/ {cls.price.toFixed(2)}
                      </p>
                    </div>
                  </div>
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col justify-end z-50 animate-fadeIn">
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              <label className="text-neutral-500 font-extrabold text-xs ml-1">Nombre de la Clase</label>
              <input
                type="text"
                required
                value={title}
            ...
            <div className="flex flex-col gap-1">
              <label className="text-neutral-500 font-extrabold text-xs ml-1">Horario y Días</label>
              <input
                type="text"
                required
                value={schedule}
            ...
            <div className="flex flex-col gap-1">
              <label className="text-neutral-500 font-extrabold text-xs ml-1">Nombre del Instructor</label>
              <input
                type="text"
                required
            ...
            <div className="flex flex-col gap-1">
              <label className="text-neutral-500 font-extrabold text-xs ml-1">Precio (S/.)</label>
              <input
                type="number"
                step="any"
                required
